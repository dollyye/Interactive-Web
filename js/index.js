...
function renderTable() {
    ...
    var currentPage = end / pages;
    var totalPage = Math.ceil((filteredData.length / pages), pages);
    var btn;
    ...
    $recordCounter.innerText = "Displaying " + start + " to " + end + " of " + filteredData.length;
    // Displays page count 
    $pageCounter.innerText = "Page " + currentPage + " of " + totalPage;
